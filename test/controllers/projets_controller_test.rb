...
class ProjetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projet" do
    assert_difference('Projet.count') do
      post projets_url, params: { projet: { contenu: @projet.contenu, debut: @projet.debut, fin: @projet.fin, nom: @projet.nom, user_id: @projet.user_id } }
    end
  ...
  test "should update projet" do
    patch projet_url(@projet), params: { projet: { contenu: @projet.contenu, debut: @projet.debut, fin: @projet.fin, nom: @projet.nom, user_id: @projet.user_id } }
